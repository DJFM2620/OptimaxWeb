...
function AddtoCart(articuloID) {
	...
	location.href = "/idat/Lentes/Carrito/" + articuloID;
}

function DetailProduct(articuloID) {

	location.href = "Articulo/Detalle/" + articuloID;
}
...
function AbrirModal() {
	...
	Cart.classList.add("Modal_Show");

	// Validamos que haya items en el carrito antes de usar el botton de "Realizar Pedido"
	var items_cart = document.getElementsByClassName("Articulo");
	var buttonOrder = document.getElementById("btnOrder");
...
function CerrarModal() {
	...
	Cart.classList.remove("Modal_Show");
}
