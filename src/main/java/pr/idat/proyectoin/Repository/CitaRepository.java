...
public interface CitaRepository extends JpaRepository<Cita, Integer>{
	...
	@Query(value = "select cod_cita,hora,fecha,citas.cod_cliente from citas inner join clientes on citas.cod_cliente=clientes.cod_cliente where clientes.dni=:clienteDNI order by fecha desc", nativeQuery=true)
